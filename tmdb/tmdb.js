...
const BACKGROUND_IMAGE = "https://www.shortlist.com/media/images/2019/05/the-30-coolest-alternative-movie-posters-ever-2-1556670563-K61a-column-width-inline.jpg"
...
exports.getDetailsApi = async (id) => {
    ...
    try {
        ...
        movie.imageUrl = movie.poster_path ? "https://image.tmdb.org/t/p/w500" + movie.poster_path : BACKGROUND_IMAGE
        return {
            movieId: id,
            title: movie.title,
